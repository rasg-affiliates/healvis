...
from healvis import observatory, sky_model, beam_model, utils, cosmo_funcs
...
def test_pspec_amp():
    ...
    vis_Ksr = cosmo_funcs.jy2Tstr(freqs) * vis_jy
    ...
    scalar = cosmo_funcs.X2Y(sky.Z_array[sky.ref_chan]) * (Bandwidth / beam_sq_int)
