...
parser.add_argument(
    "-s", "--sigma", dest="sigma", help="Sky sigma", default=2.0, type=float
)
parser.add_argument(
    "--Nside", dest="Nside", help="Sky resolution Nside", default=128, type=int
)
parser.add_argument(
    "-t",
    "--Ntimes",
...
parser.add_argument(
    "--Nskies",
    dest="Nskies",
    help="Number of sky realizations to generate.",
    default=1,
    type=int,
)
